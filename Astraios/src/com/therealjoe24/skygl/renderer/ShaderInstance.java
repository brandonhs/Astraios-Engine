...
public class ShaderInstance {
    ...
    public final static String[] defaultUniforms = { "uModelMatrix", "uProjectionMatrix", "uViewMatrix" };
     ...
     * 
     * If the value is a texture, it will be added to a list of textures to be
     * bound.
     * 
     * @param name
     * @param value
    ...
    public void SetUniforms() {
        ...
        for (String name : _auxLocations.keySet()) {
            if (_auxLocations.containsKey(name)) {
                ...
                try {
                    /**
                     * Switches the GL type to set the uniform TODO: allow for more types (EX.
                     * FloatBuffer) for use with compatible GL types
                     * 
                     */
                    switch (type) {
                    case GL_FLOAT:
